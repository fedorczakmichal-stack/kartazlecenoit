...
const cardTemplates = {
    universal: {
        ...
        continuousDrugs: [
            ...
            { name: "HEPARYNA (1ml/1j)", conc: "1ml/1j", dose: "wlew dotętniczy całodobowy 1ml/godz" }
        ],
        periodicDrugs: [
